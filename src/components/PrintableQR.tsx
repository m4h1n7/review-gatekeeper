...
/**
 * Printable QR Code generator — included in the Starter Plan.
 * Full access for all active plans: storefront / receipt / standee QR with
 * logo & accent-color customizer and high-res SVG / PNG downloads.
 */
export function PrintableQR({ slug, businessName }: PrintableQRProps) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-[#18181B]/70 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-6">
      ...
      {/* Standee Customizer — included for all plans */}
      ...
      {/* Download buttons — unlocked for all plans */}
